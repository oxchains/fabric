...
func TestPlatform_GoPathNotSet(t *testing.T) {
	...
	spec := &pb.ChaincodeSpec{
		ChaincodeId: &pb.ChaincodeID{
			Path: "/opt/gopath/src/github.com/oxchains/fabric",
		},
	}
...
func Test_findSource(t *testing.T) {
	...
	source, err = findSource(gopath, "github.com/oxchains/fabric/peer")
	if err != nil {
		t.Errorf("failed to find source: %s", err)
	}

	if _, ok := source["src/github.com/oxchains/fabric/peer/main.go"]; !ok {
...
func Test_decodeUrl(t *testing.T) {
	cs := &pb.ChaincodeSpec{
		ChaincodeId: &pb.ChaincodeID{
			Name: "Test Chaincode",
			Path: "http://github.com/oxchains/fabric/examples/chaincode/go/map",
		},
	}
...
func TestValidateSpec(t *testing.T) {
	...
	var tests = []struct {
		...
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "http://github.com/oxchains/fabric/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "https://github.com/oxchains/fabric/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/oxchains/fabric/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/oxchains/fabric/bad/chaincode/go/map"}}, succ: false},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: ":github.com/oxchains/fabric/examples/chaincode/go/map"}}, succ: false},
	}
...
func TestGetDeploymentPayload(t *testing.T) {
	...
	var tests = []struct {
		...
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/oxchains/fabric/examples/chaincode/go/map"}}, succ: true},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/oxchains/fabric/examples/bad/go/map"}}, succ: false},
		{spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/oxchains/fabric/test/chaincodes/BadImport"}}, succ: false},
	}
...
func TestGenerateDockerBuild(t *testing.T) {
	...
	specs := make([]spec, 0)
	specs = append(specs, spec{CCName: "NoCode", Path: "path/to/nowhere", File: "/bin/warez", Mode: 0100400, SuccessExpected: false})
	specs = append(specs, spec{CCName: "invalidhttp", Path: "https://not/a/valid/path", File: "/src/github.com/oxchains/fabric/examples/chaincode/go/map/map.go", Mode: 0100400, SuccessExpected: false, RealGen: true})
	specs = append(specs, spec{CCName: "map", Path: "github.com/oxchains/fabric/examples/chaincode/go/map", File: "/src/github.com/oxchains/fabric/examples/chaincode/go/map/map.go", Mode: 0100400, SuccessExpected: true, RealGen: true})
	specs = append(specs, spec{CCName: "AutoVendor", Path: "github.com/oxchains/fabric/test/chaincodes/AutoVendor/chaincode", File: "/src/github.com/oxchains/fabric/test/chaincodes/AutoVendor/chaincode/main.go", Mode: 0100400, SuccessExpected: true, RealGen: true})
	specs = append(specs, spec{CCName: "mapBadPath", Path: "github.com/oxchains/fabric/examples/chaincode/go/map", File: "/src/github.com/oxchains/fabric/examples/bad/path/to/map.go", Mode: 0100400, SuccessExpected: false})
	specs = append(specs, spec{CCName: "mapBadMode", Path: "github.com/oxchains/fabric/examples/chaincode/go/map", File: "/src/github.com/oxchains/fabric/examples/chaincode/go/map/map.go", Mode: 0100555, SuccessExpected: false})
