...
import (
	...
	"github.com/oxchains/fabric/core/scc/escc"
	"github.com/oxchains/fabric/core/scc/lscc"
	"github.com/oxchains/fabric/core/scc/qscc"
	"github.com/oxchains/fabric/core/scc/vscc"
)
...
var systemChaincodes = []*SystemChaincode{
	{
		Enabled:           true,
		Name:              "cscc",
		Path:              "github.com/oxchains/fabric/core/scc/cscc",
		InitArgs:          [][]byte{[]byte("")},
	...
	},
	{
		Enabled:           true,
		Name:              "lscc",
		Path:              "github.com/oxchains/fabric/core/scc/lscc",
		InitArgs:          [][]byte{[]byte("")},
	...
	},
	{
		Enabled:   true,
		Name:      "escc",
		Path:      "github.com/oxchains/fabric/core/scc/escc",
		InitArgs:  [][]byte{[]byte("")},
	...
	},
	{
		Enabled:   true,
		Name:      "vscc",
		Path:      "github.com/oxchains/fabric/core/scc/vscc",
		InitArgs:  [][]byte{[]byte("")},
	...
	},
	{
		Enabled:           true,
		Name:              "qscc",
		Path:              "github.com/oxchains/fabric/core/chaincode/qscc",
		InitArgs:          [][]byte{[]byte("")},
