...
#    And I quit
    ...
    When user "peer0Admin" creates a chaincode spec "ccSpec" with name "example02" of type "GOLANG" for chaincode "github.com/oxchains/fabric/examples/chaincode/go/chaincode_example02" with args
