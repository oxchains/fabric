...
# same for Vagrant.
# See https://github.com/oxchains/fabric/blob/master/docs/dev-setup/install.md
#
# To get started:
#       sudo su
#       yum install git
...
if [ -n -d $HOME/git/src/github.com/oxchains/fabric ]
then
    echo "Script fabric code is under $HOME/git/src/github.com/oxchains/fabric "
    exit
fi
