...
# 'BenchmarkInsertTxs' in package 'github.com/oxchains/fabric/test/tools/LTE/experiments'
#
# runReadWriteTxs - This function sets the environment variables and runs the benchmark function
# 'BenchmarkReadWriteTxs' in package 'github.com/oxchains/fabric/test/tools/LTE/experiments'
#
# For the details of test specific parameters, refer to the documentation in 'go' files for the tests
#######################################################################################################

PKG_NAME="github.com/oxchains/fabric/test/tools/LTE/experiments"
