...
ORDERER_CA=/opt/gopath/src/github.com/oxchains/fabric/peer/crypto/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
...
setGlobals () {
	if [ $1 -eq 0 -o $1 -eq 1 ] ; then
		...
		export CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/oxchains/fabric/peer/crypto/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt
		export CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/oxchains/fabric/peer/crypto/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp
		if [ $1 -eq 0 ]; then
		...
		export CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/oxchains/fabric/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
		export CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/oxchains/fabric/peer/crypto/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp
		if [ $1 -eq 2 ]; then
...
installChaincode () {
        ...
        do
                ...
                do
                        PEER=$i
                        setGlobals $PEER
                        peer chaincode install -n $CHAINCODE_NAME$ch -v 1 -p github.com/oxchains/fabric/examples/chaincode/go/chaincode_example02 >>$LOG_FILE
                        res=$?
