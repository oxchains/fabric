...
rm -rf $GOPATH/src/github.com/oxchains/fabric-sdk-node

WD="$GOPATH/src/github.com/oxchains/fabric-sdk-node"
SDK_REPO_NAME=fabric-sdk-node
git clone https://github.com/oxchains/$SDK_REPO_NAME $WD
cd $WD
