...
```
cd $GOPATH/src/github.com/oxchains/fabric/examples/chaincode/go/utxo/
...
```
CORE_PEER_ADDRESS=localhost:7051 peer chaincode deploy -p github.com/oxchains/fabric/examples/chaincode/go/utxo -c '{"Function":"init", "Args": []}'
```
...
```
go test github.com/oxchains/fabric/core/container -run=BuildImage_Peer
```
