...
`Chaincode interface <http://godoc.org/github.com/oxchains/fabric/core/chaincode/shim#Chaincode>`_
...
`ChaincodeStubInterface <http://godoc.org/github.com/oxchains/fabric/core/chaincode/shim#ChaincodeStub>`_
...
`peer protobuf package <http://godoc.org/github.com/oxchains/fabric/protos/peer>`_.
...
`ChaincodeStubInterface.GetStringArgs <http://godoc.org/github.com/oxchains/fabric/core/chaincode/shim#ChaincodeStub.GetStringArgs>`_
...
`ChaincodeStubInterface.PutState <http://godoc.org/github.com/oxchains/fabric/core/chaincode/shim#ChaincodeStub.PutState>`_
...
`ChaincodeStubInterface.GetFunctionAndParameters <http://godoc.org/github.com/oxchains/fabric/core/chaincode/shim#ChaincodeStub.GetFunctionAndParameters>`_
...
the `ChaincodeStubInterface.PutState <http://godoc.org/github.com/oxchains/fabric/core/chaincode/shim#ChaincodeStub.PutState>`_
and `ChaincodeStubInterface.GetState <http://godoc.org/github.com/oxchains/fabric/core/chaincode/shim#ChaincodeStub.GetState>`_
...
`shim.Start <http://godoc.org/github.com/oxchains/fabric/core/chaincode/shim#Start>`_
...
.. code:: bash
  ...
  go get -u --tags nopkcs11 github.com/oxchains/fabric/core/chaincode/shim
