...
.. code:: bash
    ...
    root@ccd3308afc73:/opt/gopath/src/github.com/oxchains/fabric/peer#
...
.. code:: bash
    ...
    CORE_PEER_ADDRESS=peer0:7051 peer chaincode install -n mycc -p github.com/oxchains/fabric/examples/chaincode/go/chaincode_example02 -v v0
...
.. code:: bash
    ...
    CORE_PEER_ADDRESS=peer0:7051 peer chaincode instantiate -o orderer:5005 -C myc -n mycc -p github.com/oxchains/fabric/examples/chaincode/go/chaincode_example02 -v v0 -c '{"Args":["init","a","100","b","200"]}'
...
.. code:: bash
    ...
    CORE_PEER_ADDRESS=peer1:7051 peer chaincode install -n mycc -p github.com/oxchains/fabric/examples/chaincode/go/chaincode_example02 -v v0
