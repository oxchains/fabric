...
import (
	...
	"github.com/oxchains/fabric/orderer/common/bootstrap/file"
	"github.com/oxchains/fabric/orderer/kafka"
	"github.com/oxchains/fabric/orderer/ledger"
	"github.com/oxchains/fabric/orderer/localconfig"
	"github.com/oxchains/fabric/orderer/metadata"
	"github.com/oxchains/fabric/orderer/multichain"
	"github.com/oxchains/fabric/orderer/solo"
...
func main() {
	...
	case start.FullCommand():
		...
		logger.Info("Beginning to serve requestss")
		grpcServer.Start()
	// "version" command
